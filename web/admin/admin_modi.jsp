...
<head>
    ...
    <body>
        ...
        <!--主要区域开始-->
        <div id="main">            
           <form action="${initParam.root}update.action" method="post"
			class="main_form">
                <div class="text_info clearfix"><span>ID：</span></div>
                    ...
                    <div class="input_info">
                     ...
                     <div class="input_info">
                        <input type="text" name="upass" value="${user.upass}" />
                    </div>
                    
                    <div class="text_info clearfix"><span>管理员账号：</span></div>
                    <div class="input_info"><input type="text" readonly="readonly" name="uname" class="readonly" value="${user.uname}"  /></div>
                    ...
                    <div class="input_info">
                        <input type="text" class="width200" name="email" value="${user.email}"/>
                        <span class="required">*</span>
                       
                    </div>
                    <div class="text_info clearfix"><span>创建时间：</span></div>
                    <div class="input_info">
                    <td ><input name="date" value='<fmt:formatDate  pattern="yyyy/MM/dd" value="${user.date}"/>'></input></td>
                    </div>
                    <div class="text_info clearfix"><span>rol：</span></div>
                     <div class="input_info">
